...
<body>
    ...
    <nav class="sidenav">
        <ul>
            <li class="pagebtn active"><img src="../image/icon/dashboardlogo.png">&nbsp&nbsp&nbsp Dashboard</li>
            <li class="pagebtn"><img src="../image/icon/reservationlogo.png">&nbsp&nbsp&nbsp Room Booking</li>
            <li class="pagebtn"><img src="../image/icon/paymentlogo.png">&nbsp&nbsp&nbsp Payment</li>            
            <li class="pagebtn"><img src="../image/icon/bedlogo.png">&nbsp&nbsp&nbsp Rooms</li>
            <li class="pagebtn"><img src="../image/icon/stafflogo.png">&nbsp&nbsp&nbsp Staff</li>
        </ul>
    </nav>

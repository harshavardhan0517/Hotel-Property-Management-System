...
$type_of_bed = $type_of_room * ($bed_percentage / 100);
...
$type_of_meal = $type_of_bed * $meal_multiplier;

$total_cost = $type_of_room + $type_of_bed + $type_of_meal;
	...
	<header>
		...
		<span><img alt="" src="../image/invoicelogo-1.jpg"></span>
	</header>
	<article>
		<h1>Recipient</h1>
		<address>
	...
	<aside>
		...
		<div>
			<p align="center">Email :- xxxxxxxx@gmail.com || Web :- www.24by7rooms.com || Phone :- +91 xxxxxxxxxxx </p>
		</div>
	</aside>

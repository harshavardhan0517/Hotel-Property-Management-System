...
--
-- Database: `hotelfinal`
-- User: `hotelfinal_user`
-- Password:   `password`
--
DROP DATABASE IF EXISTS hotelfinal;
CREATE DATABASE IF NOT EXISTS hotelfinal;

DROP USER IF EXISTS'hotelfinal_user'@'%';
CREATE USER IF NOT EXISTS 'hotelfinal_user'@'%' IDENTIFIED BY 'password';
GRANT ALL PRIVILEGES ON hotelfinal.* TO 'hotelfinal_user'@'%';
USE hotelfinal;
...
(41, 'XXXXXXXX', 'XXXXXXXXXXXX@gmail.com', 'Single Room', 'Single', 1, '2022-11-09', '2022-11-10', 1, 1000.00, 10.00, 'Room only', 0.00, 1010.00);
...
(41, 'XXXXXXXXXX', 'XXXXXXXXX@gmail.com', 'India', 'XXXXXXX', 'Single Room', 'Single', 'Room only', '1', '2022-11-09', '2022-11-10', 1, 'Confirm');
...
(1, 'XXXXXXXX', 'XXXXXXX@gmail.com', '123');

            ...
            <div id="Log_in">
                ...
                if (isset($_POST['user_login_submit'])) {
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        echo "<script>swal({ title: 'Wrong Credentials, Please verify your Credentials', icon: 'error', });</script>";
                    }
                }
                ?>
                ...
                if (isset($_POST['Emp_login_submit'])) {
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        echo "<script>swal({ title: 'Unauthorized Acess, kindly verify your Credentials', icon: 'error', });</script>";
                    }
                }
                ?>
